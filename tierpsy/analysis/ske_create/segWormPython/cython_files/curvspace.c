...
static const char __pyx_k_end_home_lschumac_tierpsy_track[] = "/end/home/lschumac/tierpsy-tracker/tierpsy/analysis/ske_create/segWormPython/cython_files/curvspace.pyx";
 ...
 */
  ...
  __pyx_codeobj__11 = (PyObject*)__Pyx_PyCode_New(2, 0, 6, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__10, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_end_home_lschumac_tierpsy_track, __pyx_n_s_curvspace, 28, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__11)) __PYX_ERR(0, 28, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
